...
//
//	mockgen -source=stringfunc.go -destination=stringfunc_mock.go -package=reader -self_package=github.com/chitoku-k/ejaculation-counter/reactor/infrastructure/reader
//
