...
//
//	mockgen -source=websocket.go -destination=websocket_mock.go -package=wrapper -self_package=github.com/chitoku-k/ejaculation-counter/supplier/infrastructure/wrapper
//
